...
src_dir = os.path.join(proj_dir, 'src_stablediff')
...
import rp
import src_stablediff.stable_diffusion as diff
from src_stablediff.bilateral_blur import BilateralProxyBlur
from src_stablediff.learnable_textures import (
